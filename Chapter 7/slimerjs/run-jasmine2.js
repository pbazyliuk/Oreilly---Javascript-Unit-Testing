    ...
    if (status !== "success") {
        ...
        waitFor(function(){
            ...
            var exitCode = page.evaluate(function(){
                ...
                var banner = el.querySelector('.title').textContent + " " +
...
//                             el.querySelector('.duration').textContent;
                ...
                if (list && list.length > 0) {
                  ...
                  console.log(document.body.querySelector('.alert > .duration').textContent);
                  console.log(document.body.querySelector('.alert > .bar.passed').textContent);
                  return 0;
                }
            });
